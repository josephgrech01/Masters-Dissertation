...
e = SumoEnv(gui=False, noWarnings=True, epLen=3000, traffic=False, mixedConfigs=False, bunched=False, save=None, continuous=False, headwayReward=True)
...
model = MaskablePPO(MaskableActorCriticPolicy, e, verbose=1, learning_rate=0.001, tensorboard_log="scenario3/tensorboard/discrete/headwayReward")
...
model.save("scenario3/models/discrete/headwayReward150000")
