...
model = PPO.load('scenario2/models/continuous/timeReward500000_2', tensorboard_log="scenario2/tensorboard/continuous/timeReward/2")
model.set_env(e)


model.learn(total_timesteps=50000, log_interval=1, reset_num_timesteps=False)
model.save("scenario2/models/continuous/timeReward550000_2")
