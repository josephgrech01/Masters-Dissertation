...
model = PPO('MlpPolicy', e, verbose=1, tensorboard_log='singapore/tensorboard/sidewalks/ppoWeightedReward', device=device)
...
model.save('singapore/models/sidewalks/ppo500000WeightedReward')
