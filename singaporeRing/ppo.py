...
model = PPO.load('singaporeRing/models/continuous/headwayReward850000', tensorboard_log="singaporeRing/tensorboard/continuous/headwayReward/eplen22000New")
model.set_env(e)

model.learn(total_timesteps=50000, log_interval=1, reset_num_timesteps=False)
model.save("singaporeRing/models/continuous/headwayReward900000")
