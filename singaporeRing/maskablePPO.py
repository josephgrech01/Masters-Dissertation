...
e = sumoMultiLine(gui=False, epLen=50000, traffic=False, headwayReward=True, saveState=False, continuous=False, bunched=False, save=None)
e = ActionMasker(e, mask_fn) # eplen was 22000
...
model = MaskablePPO(MaskableActorCriticPolicy, e, verbose=1, learning_rate=0.001, tensorboard_log="singaporeRing/tensorboard/discrete/headwayReward/epLen50000")
...
model.save("singaporeRing/models/discrete/epLen50000headwayReward150000")
