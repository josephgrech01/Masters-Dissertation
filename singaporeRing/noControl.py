...
for i in range(0,1):
    ...
    env = sumoMultiLine(gui=True, traffic=False, saveState=False, epLen=50000, continuous=False, save='singaporeRing/results/noControl/noTraffic/50000')#'singapore/results/skipping/nc/run'+str(i)+'/')
