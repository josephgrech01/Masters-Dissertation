...
model = PPO.load('scenario3/models/continuous/timeReward300000', tensorboard_log="scenario3/tensorboard/continuous/timeReward/")
model.set_env(e)

model.learn(total_timesteps=150000, log_interval=1, reset_num_timesteps=False)
model.save("scenario3/models/continuous/timeReward450000")
